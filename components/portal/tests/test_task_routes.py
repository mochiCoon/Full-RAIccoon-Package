...
class TaskRouteTests(unittest.TestCase):
    ...
    def test_dashboard_nav_renders_grouped_sections(self):
        ...
        self.assertIn(">Client Delivery<", html)
        ...
        self.assertLess(html.index(">Command<"), html.index(">Investigations<"))
        self.assertLess(html.index(">Investigations<"), html.index(">Client Delivery<"))
        self.assertLess(html.index(">Client Delivery<"), html.index(">Admin<"))
